...
% Font-th variable
$if(font-th)$
\newfontfamily{\thaifont}[Scale=MatchUppercase,Mapping=textext]{$font-th$} % ตั้งฟอนต์หลักภาษาไทยอื่นๆ
$else$
\newfontfamily{\thaifont}[Scale=MatchUppercase,Mapping=textext]{TH Sarabun New} % ตั้งฟอนต์หลักภาษาไทย ที่น่าใช้: "TH Sarabun New" (default), "Laksaman"
$endif$
